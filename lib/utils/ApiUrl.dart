class ApiUrl {
  static const String BASEURL = "https://app.faithpays.org/";
  ...
  static const String give_testimony = BASEURL + "give_testimony";
  static const String prayer_request = BASEURL + "prayer_request";
  static const String eventsCalendar = BASEURL + "eventsCalendar";
  static const String fetchEvents = BASEURL + "fetchEvents";
  static const String fetch_groups = BASEURL + "fetch_groups";
  static const String fetch_ministries = BASEURL + "fetch_ministries";
  static const String fetch_bulletins = BASEURL + "fetch_bulletins";
